...
def _transmission_response(item: Transmission) -> TransmissionResponse:
    return TransmissionResponse(
        ...
        speaker_callsign_id=getattr(item, "speaker_callsign_id", None),
        recipient_callsign_id=getattr(item, "recipient_callsign_id", None),
        speaker_text=getattr(item, "speaker_text", None),
        recipient_text=getattr(item, "recipient_text", None),
        addressed_to_agent=bool(getattr(item, "addressed_to_agent", False)),
        addressing_confidence=getattr(item, "addressing_confidence", None),
        emergency_candidate=bool(getattr(item, "emergency_candidate", False)),
        emergency_confidence=getattr(item, "emergency_confidence", None),
        emergency_reason=getattr(item, "emergency_reason", None),
