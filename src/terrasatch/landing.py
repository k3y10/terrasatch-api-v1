...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .wave{position:absolute;z-index:1;left:14px;right:14px;bottom:30px;height:calc(100% - 70px);display:flex;align-items:end;gap:3px;overflow:hidden}
    .wave i{width:4px;min-width:4px;height:var(--h);max-height:86%;border-radius:3px 3px 0 0;background:linear-gradient(180deg,#ffad59 0%,var(--orange) 46%,#7d3611 100%);opacity:.8;transform-origin:bottom;animation:pulse 1.9s ease-in-out infinite alternate;animation-delay:var(--d)}
